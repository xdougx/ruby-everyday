...
set :scm, "git"
set :repository, "git@github.com:xdougx/ruby-everyday.git"
set :branch, "master"
...
namespace :deploy do
  %w[start stop restart].each do |command|
    ...
    task command, roles: :app, except: {no_release: true} do
      run "bash /home/#{user}/#{application}/current/config/unicorn_init.sh #{command}"
